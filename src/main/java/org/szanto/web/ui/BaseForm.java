 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = org.szanto.domain.Base.class)
public class BaseForm extends CustomComponent implements EntityEditor {
