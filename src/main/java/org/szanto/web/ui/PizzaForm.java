 ...
 */
@RooVaadinVisuallyComposableEntityForm(formBackingObject = org.szanto.domain.Pizza.class)
public class PizzaForm extends CustomComponent implements EntityEditor {
    ...
    @AutoGenerated
    private TwinColSelect toppingsField;
    @AutoGenerated
    private ComboBox baseField;
    ...
    private VerticalLayout buildFieldLayout() {
        ...
        // toppingsField
        toppingsField = new TwinColSelect();
        toppingsField.setWidth("-1px");
        toppingsField.setHeight("-1px");
        toppingsField.setCaption("Toppings");
        toppingsField.setImmediate(true);
        fieldLayout.addComponent(toppingsField);

        // baseField
        baseField = new ComboBox();
        baseField.setWidth("-1px");
        baseField.setHeight("-1px");
        baseField.setCaption("Base");
        baseField.setImmediate(true);
        fieldLayout.addComponent(baseField);
